      ...
      return (
        <div
          ...
          onPointerEnter={event => {
            if (event.pointerType === 'mouse') handleMouseEnter(item.path);
          }}
        ...
        >
          {item.clickable ? (
            ...
            <button
              aria-expanded={showSubMenu === item.key}
              className={darkMode ? 'click-container-dark' : 'click-container'}
              type="button"
              onClick={() => setShowSubMenu(current => current === item.key ? null : item.key)}
            >
              <FontAwesomeIcon icon={item.icon} />
              <div className="nav-click-text-container">
                {item.name}
  ...
  return (
    ...
    >
      ...
      <div className="nav-content">
        <div className="nav-content-container nav-side-col" style={show_border}>
          <NavLink to="/">
            <div
              className={darkMode ? 'click-container-dark' : 'click-container'}
              style={{ 
        ...
        <div className="nav-center-col"> {createCenterColItems()}
        </div>

        <div
          className="nav-content-container nav-side-col"
          style={show_border}
        >
          <div className="nav-tool-click-container" onClick={toggleDarkMode}>
            {!darkMode ? <MoonFilled /> : <SunFilled />}
